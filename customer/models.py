...
class Invoice(models.Model):
    ...
    Customer_name = models.ForeignKey(Emplyoee, default=1, verbose_name="fullname", on_delete=models.SET_DEFAULT)
    Invoice_prefix = models.CharField( max_length=36, unique=True, editable=False)
    # Order_number =
    # Invoice_date =
    # Sale_person =
    # Invoice_detail =
